...
![git-repo-card](./media/git-repo-car.png)
...
[![HitCount](http://hits.dwyl.com/fredgrott/base_river.svg)](http://hits.dwyl.com/fredgrott/base_river)![Maintainer](https://img.shields.io/badge/maintainer-theMaintainer-blue)[![GitHub forks](https://img.shields.io/github/forks/fredgrott/base_river.svg?style=social&label=Fork&maxAge=2592000)](https://github.com/fredgrott/base_river/network/)[![GitHub stars](https://img.shields.io/github/stars/fredgrott/base_river.svg?style=social&label=Star&maxAge=2592000)](https://github.com/fredgrott/base_river/stargazers/)[![GitHub followers](https://img.shields.io/github/followers/fredgrott.svg?style=social&label=Follow&maxAge=2592000)](https://github.com/fredgrott?tab=followers)[![GitHub contributors](https://img.shields.io/github/contributors/fredgrott/base_river.svg)](https://github.com/fredgrott/base_river/graphs/contributors/)[![GitHub issues](https://img.shields.io/github/issues/fredgrott/base_river.svg)](https://github.com/fredgrott/base_river/issues/)[![GitHub issues-closed](https://img.shields.io/github/issues-closed/fredgrott/base_river.svg)](https://github.com/fredgrott/base_river/issues?q=is%3Aissue+is%3Aclosed)

This is a Flutter Demo project showing how to implement the RiverPod provider state management architecture.

![Screenshot](./media/screenshot.png)

And, of course, showing the full-screen aesthetic. This project is part of the flutter deep dive:

[Flutter Deep Dive repo](https://github.com/fredgrott/flutterdeepdive)

Some-time later I will git-tree this repo into that one.

## Features

-full screen app aesthetic for edge-to-edge immersive experience

-state management using riverpod and view-model dependency injection using provider

-background image along with some basic layout techniques

-basic logging and debug feedback

-basic application exception catcher plugin setup

-full cross-platform solution with full theme solution
...
-some basic project semi-automation via the derry dart script plugin
...
The articles written based on this project repo:
...
```bash
git clone https://github.com/fredgrott/base_river.git
```
